...
TEST(correctness, shl_long)
{
	...
	big_integer a("-104637598388784443044449444577438556334703518260785595038524928");
	big_integer b("-817481237412378461284761285761238721364871236412387461238476");
	b = b << 7;
	EXPECT_EQ(a, b);
